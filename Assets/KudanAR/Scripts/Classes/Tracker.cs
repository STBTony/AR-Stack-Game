...
namespace Kudan.AR
{
	public class Tracker : TrackerBase 
	{
		...
		private const int kKudanARNativeRenderEventId = 0x0a736f22;
		...
		public override void NativeRender()
		{
			#if UNITY_EDITOR

			#elif UNITY_IOS
			GL.IssuePluginEvent(GetRenderEventFunc(), kKudanARNativeRenderEventId);

			#elif UNITY_ANDROID
			if ( m_KudanAR_Instance != null )
			{
				m_KudanAR_Instance.Call( "NativeRender" );
			}
			#endif
		}
